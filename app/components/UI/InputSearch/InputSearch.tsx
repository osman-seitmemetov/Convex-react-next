...
const InputSearch: FC<InputSearchProps> = ({isPlaceholderLeft, searchTerm, handleSearch, placeholder}) => {
    ...
    return (
        <div className={`${styles.search} ${isPlaceholderLeft && styles.search_left}`}>
