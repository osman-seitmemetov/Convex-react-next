            ...
            <div className={style.dropdown}>
                <div className={style.dropdown__inner}>
                    <div className={style.dropdown__items}>
                        <Link href="">
                            <a className={style.dropdown__item}>Разное</a>
                        </Link>

                        <Link href="">
                            <a href="" className={style.dropdown__item}>Сигареты</a>
                        </Link>

                        <Link href="">
                            <a href="" className={style.dropdown__item}>Канцтовары</a>
                        </Link>

                        <Link href="">
                            <a href="" className={style.dropdown__item}>Одежда</a>
                        </Link>

                        <Link href="">
                            <a href="" className={style.dropdown__item}>Комплект</a>
                        </Link>
                    </div>

                    <Link href="/catalog">
                        <a className={style.dropdown__link}>Все категории</a>
                    </Link>
                </div>
            </div>
        </div>
